    ...
    <section className="section-spacing bg-[#fff8ef] text-[var(--text)]">
      <div className="mx-auto max-w-5xl space-y-8 px-6">
        <Reveal className="space-y-3 text-center">
          ...
          <h2 className="heading-lg">Hosting a LIFE Workshop Is Simpler Than You Think</h2>
          <p className="body-md text-[var(--muted)]">
            You do not need to be a chef, nutrition expert, or event planner. A LIFE workshop starts with a shared meal, the six pillars, and a short conversation about everyday habits.
          </p>
        </Reveal>
