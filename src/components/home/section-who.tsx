      ...
      <div className="mx-auto max-w-4xl space-y-5 px-6 text-center">
        ...
        <Reveal>
          <p className="body-md text-[var(--muted)]">
            LIFE helps neighbors host simple LIFE gatherings, teach practical habits, and register what happens so healthier routines spread city by city.
          </p>
        </Reveal>
        <Reveal className="grid gap-4 text-left body-sm text-[var(--text)] md:grid-cols-3">
          {[
            ...
            "Hosts commit to register each LIFE gathering within 24 hours so progress stays visible.",
