  ...
  return (
    <section className="bg-white text-[var(--text)]">
      <div className="mx-auto max-w-5xl px-6 py-20 text-center md:py-28">
        ...
        <h2 className="mb-4 text-3xl font-semibold tracking-tight text-[var(--life-forest)] md:text-4xl">Bring LIFE to your LIFE workshop.</h2>
        <p className="mx-auto max-w-2xl text-base leading-relaxed text-neutral-700 md:text-lg">Start with one LIFE workshop. That’s how the movement grows.</p>
