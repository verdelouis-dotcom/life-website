...
const VALUE_POINTS = [
  ...
  "Stories from shared LIFE gatherings and community hosts",
    ...
    <section id="newsletter" className="bg-[#fff8ef] py-14 text-[var(--text)]">
      <div className="mx-auto max-w-5xl space-y-8 rounded-[36px] border border-[var(--border)] bg-white/80 px-6 py-10 shadow-sm">
        <div className="space-y-3 text-center">
          ...
          <h2 className="section-heading">The Shared LIFE Gathering</h2>
          <p className="type-body-muted">
            A monthly letter from LIFE sharing stories, ideas, and updates about food, connection, and the movement to bring people back to the LIFE gathering.
          </p>
        </div>
