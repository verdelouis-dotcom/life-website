    ...
    <section className="bg-white text-[var(--text)]">
      <div className="mx-auto max-w-6xl space-y-8 px-6 py-24 text-center md:py-32">
        <Reveal className="space-y-3">
          ...
          <p className="text-base leading-relaxed text-[var(--muted)] md:text-lg">Each pillar represents a simple foundation of long-term health. Click to explore how it shows up at a LIFE gathering.</p>
        </Reveal>
