    ...
    <section className="section-spacing bg-[#fff8ef] text-[var(--text)]">
      <div className="mx-auto max-w-4xl space-y-5 px-6 text-center">
        ...
        <Reveal className="space-y-3 body-md text-[var(--muted)]">
          <p>LIFE began in Georgia, where board members host twelve LIFE workshops each year to stress-test the model.</p>
          <p>Registered LIFE workshops, host follow-up, and quarterly board reviews keep the pilot transparent as it expands.</p>
