      ...
      <div className="mx-auto max-w-5xl px-6">
        <Reveal className="overflow-hidden rounded-[32px] border border-[var(--border)] bg-[var(--surface)] shadow-lg lg:flex">
          ...
          <div className="flex flex-1 flex-col gap-5 p-8">
            <div className="inline-flex items-center gap-3 text-[var(--terracotta)]">
              <IconEducation className="h-8 w-8" />
              <span className="text-sm uppercase tracking-[0.4em]">Workshops</span>
            </div>
