      ...
      <div className="mx-auto max-w-4xl space-y-5 px-6 text-center">
        ...
        <Reveal className="space-y-3">
          <p className="type-body-muted">
            Founder Lou Verde leads LIFE through community education, hosted LIFE cooking experiences, and 30-minute keynote presentations on longevity and healthy living.
          </p>
          <p className="type-body-muted">
