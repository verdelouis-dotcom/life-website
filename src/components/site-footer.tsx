    ...
    <footer className="border-t border-[#dfd4c6] bg-[#f4efe6]">
      <div className="mx-auto max-w-6xl px-6 py-10 text-[#2e2a26]">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="text-sm">
            <p className="font-semibold text-[#2e2a26]">Keynote</p>
            <p className="mt-2 text-[#5b5149]">Request a 30-minute nonprofit keynote on longevity fundamentals.</p>
            <a
              href="/keynote"
        ...
        <div className="mt-10 rounded-3xl border border-[#dfd4c6] bg-white/60 p-6 text-sm text-[#5b5149]">
          <p className="font-semibold uppercase tracking-[0.35em] text-[#6b7a46]">Sustainability</p>
          <p className="mt-3">
