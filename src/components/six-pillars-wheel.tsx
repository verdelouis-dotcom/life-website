  ...
  return (
    <div className="relative mx-auto w-full max-w-[480px]">
      <svg viewBox={`0 0 ${SIZE} ${SIZE}`} role="img" aria-labelledby="six-pillars-title six-pillars-desc">
        ...
        <desc id="six-pillars-desc">A circular diagram showing Food, Movement, Sleep, Connection, Purpose, and Stress Regulation surrounding the shared LIFE gathering.</desc>
