...
export const metadata: Metadata = {
  ...
  description: "See how the LIFE model turns shared meals, LIFE gatherings, and local hosts into a growing community health movement.",
...
export default function HowLifeCreatesCommunityHealthPage() {
  return (
    <ResourceArticleLayout
      ...
      intro="LIFE is designed as a simple, replicable framework: attend a LIFE gathering, host a LIFE gathering, register the gathering. Each step adds data and trust, making it easier to serve more neighborhoods without diluting the mission."
      primaryCta={{ href: "/how-it-works", label: "Learn How LIFE Works" }}
      secondaryCta={{ href: "/donate", label: "Support Us", variant: "outline" }}
    >
      <ResourceSection title="LIFE Gatherings transfer practical skills">
        <p>
      ...
      <ResourceSection title="Registration keeps the model measurable">
        <p>
          Every LIFE gathering is logged through the {" "}
      ...
      <ResourceSection title="Assessment data informs next steps">
        <p>
          ...
          show which pillars need additional support. If movement or sleep scores lag in a neighborhood, LIFE can tailor LIFE gatherings and resources.
        </p>
      </ResourceSection>
