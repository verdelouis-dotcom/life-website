  ...
  return (
    ...
    >
      ...
      <ResourceSection title="Registration keeps the model measurable">
        <p>
          Every LIFE cooking experience is logged through the {" "}
      ...
      <ResourceSection title="Assessment data informs next steps">
        <p>
          ...
          show which pillars need additional support. If movement or sleep scores lag in a neighborhood, LIFE can tailor LIFE cooking experiences and resources.
        </p>
      </ResourceSection>
