...
export default function MediterraneanCookingForLongevityPage() {
  return (
    <ResourceArticleLayout
      ...
      primaryCta={{ href: "/workshops", label: "Explore Tables" }}
    ...
    >
      ...
      <ResourceSection title="Simple prep removes resistance">
        <p>
          Mediterranean cooking celebrates one-pan roasting, salads, soups, and braises. LIFE tables teach techniques that work in small
