    ...
    >
      <ResourceSection title="Food">
        <p>
          ...
          to see practical ways LIFE cooking experiences keep ingredients simple and affordable.
        </p>
      </ResourceSection>
      ...
      <ResourceSection title="Connection">
        <p>
          Belonging impacts longevity as much as some physical health markers. LIFE cooking experiences create room for mutual support and storytelling. Visit
          the {" "}
      ...
      <ResourceSection title="Putting the pillars to work">
        <p>
          ...
          . Hosts and participants revisit the pillars after each LIFE cooking experience to see which ones improved and what needs attention next.
        </p>
      </ResourceSection>
    </ResourceArticleLayout>
  );
