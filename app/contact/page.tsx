...
export const metadata: Metadata = {
  ...
  description: "Get in touch with the Longevity Initiative for Food & Education for partnerships, tables, or community table programs.",
  alternates: {
    canonical: PAGE_URL,
  },
  openGraph: {
...
const CONTACT_FAQ = [
  {
    ...
    answer:
      "Program partnerships, keynote or table requests, donation questions, and general volunteering interest are all welcome through this form.",
  },
  {
  ...
  {
    question: "Can I ask about partnerships, tables, or speaking?",
    answer:
          ...
          <div className="rounded-3xl border border-[var(--border)] bg-white/90 p-8 shadow-sm">
            ...
            <div className="mt-4 space-y-4">
              <div>
                ...
                <p className="mt-2 text-sm text-[var(--text)]">Program partnerships, keynote or table requests, donation questions, and general volunteering interest are all welcome through this form.</p>
              </div>
              <div>
              ...
              <div>
                <h3 className="text-sm font-semibold uppercase tracking-[0.3em] text-[var(--olive)]">Can I ask about partnerships, tables, or speaking?</h3>
