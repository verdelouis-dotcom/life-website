...
const CONTACT_FAQ = [
  {
    ...
    answer:
      "Program partnerships, keynote or LIFE cooking experience requests, donation questions, and general volunteering interest are all welcome through this form.",
  },
  {
  ...
  {
    question: "Can I ask about partnerships, LIFE cooking experiences, or speaking?",
    answer:
        ...
        <section className="section-spacing">
          <div className="mx-auto max-w-4xl rounded-[40px] border border-[var(--border)] bg-white/90 p-10 shadow-sm">
            ...
            <p className="mt-4 body-md text-[var(--muted)]">
              Use this form for partnerships, hosted LIFE cooking experience requests, keynote inquiries, or general questions. We respond within two business days.
            </p>
            <ul className="mt-4 space-y-2 body-sm text-[var(--text)] text-left">
              <li>• Partnership or hosted LIFE cooking experience requests</li>
              <li>• Host or LIFE cooking experience support questions</li>
          ...
          <aside className="rounded-3xl border border-[var(--border)] bg-[#fff8ef] card-padding shadow-sm">
            ...
            <ul className="mt-4 space-y-3 body-sm text-[var(--text)]">
              ...
              <li>
                ...
                in piloting LIFE cooking experiences.
              </li>
              <li>
          ...
          <div className="rounded-3xl border border-[var(--border)] bg-white/90 p-8 shadow-sm">
            ...
            <div className="mt-4 space-y-4">
              <div>
                ...
                <p className="mt-2 text-sm text-[var(--text)]">Program partnerships, keynote or LIFE cooking experience requests, donation questions, and general volunteering interest are all welcome through this form.</p>
              </div>
              <div>
              ...
              <div>
                <h3 className="text-sm font-semibold uppercase tracking-[0.3em] text-[var(--olive)]">Can I ask about partnerships, LIFE cooking experiences, or speaking?</h3>
