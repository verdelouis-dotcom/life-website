...
const BOARD_PRACTICES = [
  "Quarterly reviews covering LIFE cooking experience registrations, donations, and pilot risks.",
  "Dual-approval process for program expenses and grant disbursements.",
  "Public reporting on registered LIFE cooking experiences, host commitments, and assessment insights.",
];
    ...
    <>
      <main className="bg-[var(--bg)] text-[var(--text)]">
        <section className="mx-auto max-w-5xl px-6 py-16">
          <div className="rounded-[40px] border border-[var(--border)] bg-white/90 p-10 shadow-sm">
            ...
            <p className="mt-4 text-lg text-[var(--muted)]">
              ...
              communities possible: fresh ingredients, shared LIFE cooking experiences, and long-term accountability.
            </p>
            <p className="mt-4 body-md text-[var(--text)]">A LIFE cooking experience is a shared meal where people cook, learn, and connect.</p>
          </div>
        </section>
        ...
        <section className="mx-auto grid max-w-5xl gap-6 px-6 pb-12 md:grid-cols-2">
          <article className="rounded-3xl border border-[var(--border)] bg-white/90 p-6 shadow-sm">
            ...
            <p className="mt-3 text-sm leading-6 text-[var(--text)]">
              ...
              transparency. Every cooking experience focuses on food quality, connection, and replicable education.
            </p>
          </article>
          <article className="rounded-3xl border border-[var(--border)] bg-white/90 p-6 shadow-sm">
            <h2 className="text-2xl font-semibold text-[var(--life-forest)]">Why the LIFE Cooking Experience Matters</h2>
            <p className="mt-3 text-sm leading-6 text-[var(--text)]">
        ...
        <section className="mx-auto max-w-5xl space-y-6 px-6 pb-12">
          <article className="rounded-3xl border border-[var(--border)] bg-[#fff8ef] p-8 shadow-sm">
            ...
            <p className="mt-3 text-sm leading-7 text-[var(--text)]">
              Lou Verde grew up in a home where the LIFE cooking experience was sacred—three generations cooking, eating, and taking care of each other with fresh ingredients.
              ...
              what he already knew: shared meals, purpose, and responsibility extend healthy years. The first public cooking experiences piloted in Georgia so the
          ...
          <article className="rounded-3xl border border-[var(--border)] bg-white/90 p-8 shadow-sm">
            ...
            <ul className="mt-4 space-y-3 text-sm text-[var(--text)]">
              ...
              <li>• Hosts register every LIFE cooking experience so reach, attendance, and impact are measurable.</li>
        ...
        <PhotoHighlight
          ...
          title="Why LIFE started at a single shared LIFE cooking experience"
          body="Lou Verde traveled to Italy to study longevity traditions firsthand, learning the art of making pasta from scratch before translating those lessons into small shared LIFE cooking experiences back home. Every LIFE cooking experience photo, registered LIFE cooking experience, and assessment reflection feeds the next host so the model stays grounded in real families."
