...
export const metadata: Metadata = {
  title: "How LIFE Cooking Experiences Work | Longevity Initiative",
  description: "See how the LIFE shared LIFE cooking experience model spreads longevity habits through community meals, cooking education, and connection.",
  alternates: {
    canonical: PAGE_URL,
  },
  openGraph: {
...
const STEP_CONTENT = [
  {
    title: "1. Attend a LIFE Cooking Experience",
    body: "Sit down, share a meal, and take part in real conversation so you can see how LIFE feels.",
  },
  {
    title: "2. Host a LIFE Cooking Experience",
    body: "Within 30 days, host a simple cooking experience of your own. Teach a favorite recipe or family tradition while sharing the LIFE pillars.",
  },
  {
    title: "3. Add Your Table to the Map",
    body: "Log your cooking experience so it counts. Each registered table extends the ripple and keeps the movement measurable for the next host.",
  },
];

const HOW_IT_WORKS_FAQ = [
  {
    question: "Do I need experience to host a LIFE cooking experience?",
    answer:
  ...
  },
  {
    ...
    answer: "You register the LIFE cooking experience online, submit attendance, and note any stories. The LIFE team follows up with resources so you can host again or mentor another host.",
  },
  {
    question: "Is registering a LIFE cooking experience required?",
      ...
      <main className="bg-[var(--bg)] text-[var(--text)]">
        <section className="section-spacing">
          <div className="mx-auto max-w-5xl rounded-[40px] border border-[var(--border)] bg-[#fff8ef] p-10 shadow-sm">
            ...
            <p className="mt-3 body-md text-[var(--text)]">A LIFE cooking experience is a shared meal where neighbors cook, eat, and commit to passing it on. Attend once, host within 30 days, and the table keeps growing.</p>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-5xl px-6 pb-12">
          ...
          <p className="mt-8 text-center body-md text-[var(--text)]">
            LIFE grows one LIFE cooking experience at a time: people attend, host within 30 days, teach what they know, and register so every cooking experience adds proof.
          </p>
        ...
        <section className="mx-auto max-w-4xl px-6 pb-8">
          <div className="rounded-[32px] border border-[var(--border)] bg-[#fff8ef] card-padding shadow-sm">
            <h3 className="heading-md">Some hosts continue beyond their first LIFE cooking experience.</h3>
            <p className="mt-3 body-sm text-[var(--text)]">
              After hosting once, many neighbors choose to become <strong>LIFE Host Champions</strong>—volunteers who host multiple LIFE cooking experiences each year,
          ...
          <div className="rounded-3xl border border-[var(--border)] bg-[#fff8ef] card-padding shadow-sm">
            ...
            <div className="mt-4 space-y-4">
              ...
              <div>
                ...
                <p className="mt-2 body-sm text-[var(--text)]">You log the cooking experience online, submit attendance, and note any stories. The LIFE team follows up with resources so you can host again or mentor the next host.</p>
              </div>
              <div>
                <h3 className="label-text text-[var(--olive)]">Is logging my cooking experience required?</h3>
        ...
        <section className="mx-auto max-w-5xl px-6 pb-12">
          <div className="rounded-3xl border border-[var(--border)] bg-white/90 card-padding shadow-sm">
            ...
            <p className="mt-3 body-md text-[var(--text)]">
              Registration data, attendance records, and host follow-up allow LIFE to report on reach, repeat cooking experiences, and qualitative stories. During the pilot we share quarterly summaries with donors and partners so replication decisions stay rooted in data.
            </p>
          </div>
        </section>
