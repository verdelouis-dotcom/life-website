      ...
      <main className="bg-[var(--bg)] text-[var(--text)]">
        ...
        <section className="mx-auto max-w-4xl px-6 pb-8">
          <div className="rounded-[32px] border border-[var(--border)] bg-[#fff8ef] card-padding shadow-sm">
            <h3 className="heading-md">Some hosts continue beyond their first table.</h3>
        ...
        <section className="mx-auto max-w-5xl px-6 pb-12">
          <div className="rounded-3xl border border-[var(--border)] bg-[#fff8ef] card-padding shadow-sm">
            ...
            <div className="mt-4 space-y-4">
              <div>
                <h3 className="label-text text-[var(--olive)]">Do I need experience to host a LIFE table?</h3>
              ...
              <div>
                ...
                <p className="mt-2 body-sm text-[var(--text)]">You register the table online, submit attendance, and note any stories. The LIFE team follows up with resources so you can host again or mentor another host.</p>
              </div>
              <div>
                <h3 className="label-text text-[var(--olive)]">Is registering a table required?</h3>
