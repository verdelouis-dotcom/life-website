...
const LIFE_TIE_IN = [
  ...
  "The hosted LIFE workshop model also reframes health as a full-life practice. Better meals and better connection can make it easier for people to settle into more restorative patterns overall.",
];
...
export default function SleepPillarPage() {
  return (
    <PillarPage
      ...
      intro="Sleep affects energy, mood, judgment, recovery, and long-term health. LIFE includes sleep because healthier living is not just about what happens at the LIFE workshop — it is also about the rhythms that restore the body."
      why={WHY}
      research={RESEARCH}
