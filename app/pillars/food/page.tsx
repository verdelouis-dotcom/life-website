...
const pageTitle = `${pillar?.title ?? "Food"} Pillar | LIFE`;
const pageDescription = pillar?.summary ?? "Explore the LIFE Food pillar focused on fresh ingredients and shared meals.";
