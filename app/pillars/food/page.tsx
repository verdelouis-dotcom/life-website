...
const LIFE_TIE_IN = [
  "LIFE brings nutrition out of theory and into the kitchen. When a host teaches one meal at a shared table, healthy eating becomes visible, social, and easier to repeat.",
  "The table helps bridge the gap between information and action. People do not just hear what to eat — they cook it, taste it, and leave with something they can recreate at home.",
];
...
export default function FoodPillarPage() {
  return (
    <PillarPage
      ...
      intro="Food is not just fuel. It shapes energy, habits, family routines, and the quality of daily life. LIFE uses the shared table to help people return to meals built from real ingredients, practical cooking, and connection."
      why={WHY}
      research={RESEARCH}
